...
int debugPrintf(char *text, ...) {
  ...
  SceUID fd = sceIoOpen("ux0:data/s4ep2_log.txt", SCE_O_WRONLY | SCE_O_CREAT | SCE_O_APPEND, 0777);
  if (fd >= 0) {
...
__attribute__((naked)) void CPlane__ProcessControlInputs_Rudder_stub(void) {
  ...
  register uintptr_t retAddr asm ("r12") = (uintptr_t)s4ep2_mod.text_base + 0x0057611A + 0x1;
...
__attribute__((naked)) void CPlane__ProcessControlInputs_Harrier_stub(void) {
  ...
  register uintptr_t retAddr asm ("r12") = (uintptr_t)s4ep2_mod.text_base + 0x005765F0 + 0x1;
...
__attribute__((naked)) void CCam__Process_FollowCar_SA_camSetArrPos_stub(void) {
  ...
  register uintptr_t retAddr asm ("r12") = (uintptr_t)s4ep2_mod.text_base + 0x003C033A + 0x1;
...
__attribute__((naked)) void CCam__Process_FollowCar_SA_yMovement_stub(void) {
  ...
  register uintptr_t retAddr asm ("r12") = (uintptr_t)s4ep2_mod.text_base + 0x003C1308 + 0x1;
...
__attribute__((naked)) void CPad__AimWeaponUpDown_stub(void) {
  ...
  register uintptr_t retAddr asm ("r12") = (uintptr_t)s4ep2_mod.text_base + 0x003FC782 + 0x1;
...
__attribute__((naked)) void CPad__AimWeaponLeftRight_stub(void) {
  ...
  register uintptr_t retAddr asm ("r12") = (uintptr_t)s4ep2_mod.text_base + 0x003FC490 + 0x1;
...
void patch_game(void) {
  *(uint8_t *)so_symbol(&s4ep2_mod, "UseCloudSaves") = 0;
  *(uint8_t *)so_symbol(&s4ep2_mod, "UseTouchSense") = 0;

  if (config.disable_detail_textures)
    *(int *)so_symbol(&s4ep2_mod, "gNoDetailTextures") = 1;

  hook_addr(so_symbol(&s4ep2_mod, "_Z14IsRemovedTracki"), (uintptr_t)ret0);

  // QueueUpTracksForStation
  hook_addr((uintptr_t)s4ep2_mod.text_base + 0x003A152A + 0x1, (uintptr_t)s4ep2_mod.text_base + 0x003A1602 + 0x1);

  // ChooseMusicTrackIndex
  hook_addr((uintptr_t)s4ep2_mod.text_base + 0x003A35F6 + 0x1, (uintptr_t)s4ep2_mod.text_base + 0x003A369A + 0x1);

  // ChooseIdentIndex
  hook_addr((uintptr_t)s4ep2_mod.text_base + 0x003A37C2 + 0x1, (uintptr_t)s4ep2_mod.text_base + 0x003A385E + 0x1);

  // ChooseAdvertIndex
  hook_addr((uintptr_t)s4ep2_mod.text_base + 0x003A3A1E + 0x1, (uintptr_t)s4ep2_mod.text_base + 0x003A3AA2 + 0x1);

  // ChooseTalkRadioShow
  hook_addr((uintptr_t)s4ep2_mod.text_base + 0x003A4374 + 0x1, (uintptr_t)s4ep2_mod.text_base + 0x003A4416 + 0x1);

  // ChooseDJBanterIndexFromList
  hook_addr((uintptr_t)s4ep2_mod.text_base + 0x003A44D6 + 0x1, (uintptr_t)s4ep2_mod.text_base + 0x003A4562 + 0x1);
  ...
  if (config.fix_heli_plane_camera) {
    ...
    kuKernelCpuUnrestrictedMemcpy((void *)(s4ep2_mod.text_base + 0x003C0866), &movs_r0_0, sizeof(movs_r0_0));
    kuKernelCpuUnrestrictedMemcpy((void *)(s4ep2_mod.text_base + 0x003C1518), &movs_r0_0, sizeof(movs_r0_0));
    kuKernelCpuUnrestrictedMemcpy((void *)(s4ep2_mod.text_base + 0x003C198A), &movs_r0_0, sizeof(movs_r0_0));

    kuKernelCpuUnrestrictedMemcpy((void *)(s4ep2_mod.text_base + 0x003FC462), &movs_r0_0, sizeof(movs_r0_0));
    kuKernelCpuUnrestrictedMemcpy((void *)(s4ep2_mod.text_base + 0x003FC754), &movs_r0_0, sizeof(movs_r0_0));

    // Fix Harrier thruster control
    hook_addr((uintptr_t)(s4ep2_mod.text_base + 0x003C057C + 0x1), (uintptr_t)CCam__Process_FollowCar_SA_camSetArrPos_stub);
    hook_addr((uintptr_t)(s4ep2_mod.text_base + 0x003C12F4 + 0x1), (uintptr_t)CCam__Process_FollowCar_SA_yMovement_stub);

    CPad__GetPad = (void *)so_symbol(&s4ep2_mod, "_ZN4CPad6GetPadEi");
    CPad__GetCarGunUpDown = (void *)so_symbol(&s4ep2_mod, "_ZN4CPad15GetCarGunUpDownEbP11CAutomobilefb");
    CPad__GetSteeringLeftRight = (void *)so_symbol(&s4ep2_mod, "_ZN4CPad20GetSteeringLeftRightEv");
    CPad__GetTurretLeft = (void *)so_symbol(&s4ep2_mod, "_ZN4CPad13GetTurretLeftEv");
    CPad__GetTurretRight = (void *)so_symbol(&s4ep2_mod, "_ZN4CPad14GetTurretRightEv");
    CTimer__ms_fTimeStep = (float *)so_symbol(&s4ep2_mod, "_ZN6CTimer12ms_fTimeStepE");
    hook_addr((uintptr_t)(s4ep2_mod.text_base + 0X005760BA + 0x1), (uintptr_t)CPlane__ProcessControlInputs_Rudder_stub);
    hook_addr((uintptr_t)(s4ep2_mod.text_base + 0x00576432 + 0x1), (uintptr_t)CPlane__ProcessControlInputs_Harrier_stub);
  }

  // Force using GL_UNSIGNED_SHORT
  if (config.fix_skin_weights) {
    uint16_t movs_r1_1 = 0x2101;
    kuKernelCpuUnrestrictedMemcpy((void *)(s4ep2_mod.text_base + 0x001C8064), &movs_r1_1, sizeof(movs_r1_1));
    kuKernelCpuUnrestrictedMemcpy((void *)(s4ep2_mod.text_base + 0x001C8082), &movs_r1_1, sizeof(movs_r1_1));
  }

  if (config.enable_high_detail_player)
    hook_addr(so_symbol(&s4ep2_mod, "_Z17UseHiDetailPlayerv"), (uintptr_t)ret1);

  if (config.enable_bones_optimization) {
    skin_map = (float *)so_symbol(&s4ep2_mod, "skin_map");
    skin_dirty = (int *)so_symbol(&s4ep2_mod, "skin_dirty");
    skin_num = (int *)so_symbol(&s4ep2_mod, "skin_num");
    hook_addr(so_symbol(&s4ep2_mod, "_Z30emu_InternalSkinGetVectorCountv"), (uintptr_t)emu_InternalSkinGetVectorCount);
    hook_addr((uintptr_t)s4ep2_mod.text_base + 0x001C8670 + 0x1, (uintptr_t)SkinSetMatrices);
  }

  if (config.enable_mvp_optimization) {
    GetCurrentProjectionMatrix = (void *)so_symbol(&s4ep2_mod, "_Z26GetCurrentProjectionMatrixv");
    GetCurrentViewMatrix = (void *)so_symbol(&s4ep2_mod, "_Z20GetCurrentViewMatrixv");
    GetCurrentObjectMatrix = (void *)so_symbol(&s4ep2_mod, "_Z22GetCurrentObjectMatrixv");
    hook_addr(so_symbol(&s4ep2_mod, "_ZN9ES2Shader17SetMatrixConstantE24RQShaderMatrixConstantIDPKf"), (uintptr_t)ES2Shader__SetMatrixConstant);
  }
  ...
  if (config.ignore_mobile_stuff) {
    ...
    kuKernelCpuUnrestrictedMemcpy((void *)(s4ep2_mod.text_base + 0x0043A7A0), &nop32, sizeof(nop32));
    kuKernelCpuUnrestrictedMemcpy((void *)(s4ep2_mod.text_base + 0x004627E6), &nop32, sizeof(nop32));

    // Ignore side mission buttons (vigilante, paramedic, etc)
    hook_addr(so_symbol(&s4ep2_mod, "_ZN25CWidgetButtonMissionStart6UpdateEv"), (uintptr_t)ret0);
    hook_addr(so_symbol(&s4ep2_mod, "_ZN26CWidgetButtonMissionCancel6UpdateEv"), (uintptr_t)ret0);

    // Ignore steering control popup
    kuKernelCpuUnrestrictedMemcpy((void *)(s4ep2_mod.text_base + 0x003F91B6), &nop16, sizeof(nop16));

    // Ignore app rating popup
    hook_addr(so_symbol(&s4ep2_mod, "_Z12Menu_ShowNagv"), (uintptr_t)ret0);

    // Ignore items in the controls menu
    kuKernelCpuUnrestrictedMemcpy((void *)(s4ep2_mod.text_base + 0x0029E4AE), &nop32, sizeof(nop32));
    kuKernelCpuUnrestrictedMemcpy((void *)(s4ep2_mod.text_base + 0x0029E4E6), &nop32, sizeof(nop32));
    kuKernelCpuUnrestrictedMemcpy((void *)(s4ep2_mod.text_base + 0x0029E50A), &nop32, sizeof(nop32));
    kuKernelCpuUnrestrictedMemcpy((void *)(s4ep2_mod.text_base + 0x0029E530), &nop32, sizeof(nop32));
  }

  // Remove map highlight (explored zones) since alpha blending is very expensive
  hook_addr((uintptr_t)s4ep2_mod.text_base + 0x002AADE0 + 0x1, (uintptr_t)s4ep2_mod.text_base + 0x002AAF9A + 0x1);

  // fix free aiming
  hook_addr((uintptr_t)s4ep2_mod.text_base + 0x004C6D16 + 0x1, (uintptr_t)s4ep2_mod.text_base + 0x004C6E28 + 0x1);

  // Fix target switching firing twice
  hook_addr((uintptr_t)s4ep2_mod.text_base + 0x003C73F8 + 0x1, (uintptr_t)s4ep2_mod.text_base + 0x003C7424 + 0x1);

  // Disable auto landing gear deployment/retraction
  hook_addr((uintptr_t)s4ep2_mod.text_base + 0x0057629C + 0x1, (uintptr_t)s4ep2_mod.text_base + 0x005762BC + 0x1);

  // Nuke telemetry
  hook_addr(so_symbol(&s4ep2_mod, "_Z13SaveTelemetryv"), (uintptr_t)ret0);
  hook_addr(so_symbol(&s4ep2_mod, "_Z13LoadTelemetryv"), (uintptr_t)ret0);
  hook_addr(so_symbol(&s4ep2_mod, "_Z11updateUsageb"), (uintptr_t)ret0);

  hook_addr(so_symbol(&s4ep2_mod, "__cxa_guard_acquire"), (uintptr_t)&__cxa_guard_acquire);
  hook_addr(so_symbol(&s4ep2_mod, "__cxa_guard_release"), (uintptr_t)&__cxa_guard_release);

  hook_addr(so_symbol(&s4ep2_mod, "_Z24NVThreadGetCurrentJNIEnvv"), (uintptr_t)NVThreadGetCurrentJNIEnv);

  // do not use pthread
  hook_addr(so_symbol(&s4ep2_mod, "_Z15OS_ThreadLaunchPFjPvES_jPKci16OSThreadPriority"), (uintptr_t)OS_ThreadLaunch);

  // do not use mutex for RenderQueue
  hook_addr(so_symbol(&s4ep2_mod, "_Z17OS_ThreadSetValuePv"), (uintptr_t)OS_ThreadSetValue);

  hook_addr(so_symbol(&s4ep2_mod, "_Z17OS_ScreenGetWidthv"), (uintptr_t)OS_ScreenGetWidth);
  hook_addr(so_symbol(&s4ep2_mod, "_Z18OS_ScreenGetHeightv"), (uintptr_t)OS_ScreenGetHeight);

  // TODO: set deviceChip, definedDevice
  hook_addr(so_symbol(&s4ep2_mod, "_Z20AND_SystemInitializev"), (uintptr_t)ret0);

  // TODO: implement touch here
  hook_addr(so_symbol(&s4ep2_mod, "_Z13ProcessEventsb"), (uintptr_t)ProcessEvents);

  // no adjustable
  hook_addr(so_symbol(&s4ep2_mod, "_ZN14CAdjustableHUD10SaveToDiskEv"), (uintptr_t)ret0);
  hook_addr(so_symbol(&s4ep2_mod, "_ZN15CTouchInterface27RepositionAdjustableWidgetsEv"), (uintptr_t)ret0);

  // cheats support
  CCheat__AddToCheatString = (void *)so_symbol(&s4ep2_mod, "_ZN6CCheat16AddToCheatStringEc");
  kuKernelCpuUnrestrictedMemcpy((void *)so_symbol(&s4ep2_mod, "_ZN6CCheat16m_aCheatHashKeysE"), CCheat__m_aCheatHashKeys, sizeof(CCheat__m_aCheatHashKeys));
  hook_addr(so_symbol(&s4ep2_mod, "_ZN6CCheat8DoCheatsEv"), (uintptr_t)CCheat__DoCheats);

  // hook buttons mapping
  CHIDJoystickPS3__vtable = (void *)so_symbol(&s4ep2_mod, "_ZTV15CHIDJoystickPS3");
  CHIDJoystick__CHIDJoystick = (void *)so_symbol(&s4ep2_mod, "_ZN12CHIDJoystickC2EPKc");
  CHIDJoystick__AddMapping = (void *)so_symbol(&s4ep2_mod, "_ZN12CHIDJoystick10AddMappingEi10HIDMapping");
  if (mapping_count == 0)
    hook_addr(so_symbol(&s4ep2_mod, "_ZN15CHIDJoystickPS3C2EPKc"), (uintptr_t)so_symbol(&s4ep2_mod, "_ZN19CHIDJoystickXbox360C2EPKc"));
  else
    hook_addr(so_symbol(&s4ep2_mod, "_ZN15CHIDJoystickPS3C2EPKc"), (uintptr_t)CHIDJoystickPS3__CHIDJoystickPS3);

  // Change IsReleased to IsJustPressed for some mappings
  CHID__IsJustPressed = (void *)so_symbol(&s4ep2_mod, "_ZN4CHID13IsJustPressedE10HIDMapping");
  CHID__IsReleased = (void *)so_symbol(&s4ep2_mod, "_ZN4CHID10IsReleasedE10HIDMapping");
  hook_addr((uintptr_t)s4ep2_mod.text_base + 0x0018DFC4, (uintptr_t)CHID__IsReleased_Hook);

  // Redirect taxi boost jump to custom binding
  CPed__IsPlayer = (void*)so_symbol(&s4ep2_mod, "_ZNK4CPed8IsPlayerEv");
  CPhysical__ApplyMoveForce = (void *)so_symbol(&s4ep2_mod, "_ZN9CPhysical14ApplyMoveForceE7CVector");
  CPhysical__ApplyTurnForce = (void *)so_symbol(&s4ep2_mod, "_ZN9CPhysical14ApplyTurnForceE7CVectorS0_");
  hook_addr(so_symbol(&s4ep2_mod, "_ZN11CAutomobile16BoostJumpControlEv"), (uintptr_t)CAutomobile__BoostJumpControl);

  // Fix hydraulics lock so the right analog stick can be used as camera again
  hook_addr(so_symbol(&s4ep2_mod, "_ZN4CPad16GetHydraulicJumpEv"), (uintptr_t)CPad__GetHydraulicJump);
  hook_addr((uintptr_t)(s4ep2_mod.text_base + 0x003FC778 + 0x1), (uintptr_t)CPad__AimWeaponUpDown_stub);
  hook_addr((uintptr_t)(s4ep2_mod.text_base + 0x003FC486 + 0x1), (uintptr_t)CPad__AimWeaponLeftRight_stub);

  // make resume load the latest save
  CGenericGameStorage__CheckSlotDataValid = (void *)so_symbol(&s4ep2_mod, "_ZN19CGenericGameStorage18CheckSlotDataValidEib");
  C_PcSave__GenerateGameFilename = (void *)so_symbol(&s4ep2_mod, "_ZN8C_PcSave20GenerateGameFilenameEiPc");
  OS_FileGetDate = (void *)so_symbol(&s4ep2_mod, "_Z14OS_FileGetDate14OSFileDataAreaPKc");
  PcSaveHelper = (void *)so_symbol(&s4ep2_mod, "PcSaveHelper");
  lastSaveForResume = (void *)so_symbol(&s4ep2_mod, "lastSaveForResume");
  hook_addr(so_symbol(&s4ep2_mod, "_ZN14MainMenuScreen9HasCPSaveEv"), (uintptr_t)MainMenuScreen__HasCPSave);

  // support graceful exit
  SaveGameForPause = (void *)so_symbol(&s4ep2_mod, "_Z16SaveGameForPause10eSaveTypesPc");
  hook_addr(so_symbol(&s4ep2_mod, "_ZN14MainMenuScreen6OnExitEv"), (uintptr_t)MainMenuScreen__OnExit);
}
...
int main(int argc, char *argv[]) {
  ...
  if (so_load(&s4ep2_mod, SO_PATH, LOAD_ADDRESS) < 0)
    fatal_error("Error could not load %s.", SO_PATH);

  stderr_fake = stderr;
  so_relocate(&s4ep2_mod);
  so_resolve(&s4ep2_mod, default_dynlib, sizeof(default_dynlib), 0);
  ...
  patch_gfx();
  patch_scripts();
  so_flush_caches(&s4ep2_mod);

  so_initialize(&s4ep2_mod);
